...
class Process implements Runnable {
    ...
    //Feature 1: Added prioity attribute for each process
...
public class SchedulerSimulation {
    static int contextSwitches = 0;//feature2: counter for countext switches
    public static void main(String[] args) {
        // ⚠️ IMPORTANT: Put your student ID here to seed the random number generator
        // This makes your output unique to you - DO NOT forget to change this!
        int studentID = 445052062;  // ← CHANGE THIS TO YOUR ACTUAL STUDENT ID
        ...
        System.out.println(Colors.BOLD + Colors.BRIGHT_GREEN + 
                          "╚════════════════════════════════════════════════════════════════════════════════╝" + 
                          Colors.RESET + "\n");
                          System.out.println("Total context switches: " + contextSwitches);//feature 2:display total context switches
    }
